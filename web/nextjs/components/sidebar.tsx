...
const SOURCES: Array<{ type: string; label: string; countKey: keyof NonNullable<Counts["sources"]> }> = [
  ...
  { type: "git_dirty_worktree",   label: c("source.gitDirtyWorktree"), countKey: "git_dirty_worktree" },
  { type: "orphan_branch",       label: c("source.orphanBranch"), countKey: "orphan_branch" },
  { type: "gh_review_request",   label: c("source.ghReviewRequest"), countKey: "gh_review_request" },
  { type: "gh_unresolved_thread", label: c("source.ghUnresolvedThread"), countKey: "gh_unresolved_thread" },
  { type: "docs_checklist",      label: c("source.docsChecklist"), countKey: "docs_checklist" },
