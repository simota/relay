...
const SOURCE_TONE: Record<SourceType, string> = {
  ...
  git_dirty_worktree: "text-[var(--color-warm)] border-[var(--color-warm)]/40",
  orphan_branch: "text-[var(--color-warm)] border-[var(--color-warm)]/40",
  gh_review_request: "text-[var(--color-cool)] border-[var(--color-cool)]/40",
  gh_unresolved_thread: "text-[var(--color-critical)] border-[var(--color-critical)]/40",
  docs_checklist: "text-[var(--color-fg-muted)] border-[var(--color-border)]",
